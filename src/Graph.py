...
class Graph:
    ...
    def add_iteration_auth_hub(self):
        self.auth, self.hub = self.get_auth_hub_list()
        self.iteration_auth.append(self.auth)
        self.iteration_hub.append(self.hub)

    def get_iteration_auth_hub(self):
        return self.iteration_auth, self.iteration_hub
    ...
    def add_iteration_pagerank(self):
        self.iteration_pagerank.append(self.get_pagerank_list())

    def get_iteration_pagerank(self):
        return self.iteration_pagerank
